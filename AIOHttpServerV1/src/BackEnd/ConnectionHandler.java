...
public class ConnectionHandler
    ...
    public void completed(AsynchronousSocketChannel channelClient, Attachment att){
        try{
            ...
            /* call accept() with the passed attachment object and a reference to
            the current completion handler as arguments. This call allows the server
            to respond to the next incoming connection.
             */
